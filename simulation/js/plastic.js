...
document.addEventListener("DOMContentLoaded", function () {
    ...
    keys.forEach(function (val, ind) {
      if (
        ...
        if (step === 3 && val === "soil") {
          ...
          hover = true;
          if (flag) {
            objs["soil"] = new soilThread(
              height,
              width,
              objs["plate"].pos[0] + objs["plate"].width / 2 - width / 2,
              objs["plate"].pos[1] + objs["plate"].height / 2 - height / 2,
            );
          }
  ...
  const msgs = [
    ...
    "Click on the soil to roll it into a rod of diameter 3 mm. Finally, determine the water content of the obtained soil pieces. Use the following <a href='https://smfe-iiith.vlabs.ac.in/exp/water-content/'>link</a> to learn more about water content determination.",
